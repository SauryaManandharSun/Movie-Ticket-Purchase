...
const AddShows = () => {
    ...
    return nowPlayingMovies.length > 0 ? (
        <>
            ...
            {/* Price Input */}
            <div className='mt-8'>
                <label className='block text-sm font-medium mb-2'>Show Price
            ...
            <div className='mt-6'>
                ...
                <div className='inline-flex gap-5 border border-gray-400 p-1 pl-3 rounded-lg'>
                    ...
                    <button onClick={handleDateTimeAdd} className='bg-primary/80 text-white px-3 py-2 text-sm rounded-lg hover:bg-primary cursor-pointer'>Add Time
            ...
            {Object.keys(dateTimeSelection).length > 0 && (
                <div className='mt-6'>
                    <h2 className='mb-2'> Selected Date-Time
            ...
            <button className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'>Add Show
